...
- validación de los ejes horizontal y vertical frente a OTDR_PC mediante archivos de referencia controlados;
...
## Fase 4 — Formatos emparejados y diagnóstico terminal
...
La entrega archivada más reciente se concentra en comportamiento terminal y diagnóstico de localización:
...
Dos componentes importantes de la base son idénticos byte a byte en todas las entregas archivadas desde **v0.1.0 hasta v0.3.4**:

- `scanner.py` — escáner estructural SOR;
- `exfo_ftb7200_sor2.json` — perfil EXFO utilizado como referencia validada.

Esa continuidad ayuda a entender la migración pública: las versiones posteriores añaden principalmente interpretación semántica, evidencia, análisis de eventos, soporte EI y comportamiento del visor sobre un núcleo estructural estable.
...
La secuencia pública prevista es:
